...
class Patient_requestQuery extends Query {
	...
	function insert($patient_request) {
		$sql = $this->mkSQL("insert into patient_request values (%N, %N, %N, %Q, %Q, %Q)",
	...
	function updateRequest_id($patient_request) {
		$sql = $this->mkSQL("update patient_request
				set patient_id = %N, schedule_id = %N, problem_history = %Q, actual_date_of_consultation = %Q, time_of_consultation = %Q where request_id = %N ",
	...
	function updatePatient_id($patient_request) {
		$sql = $this->mkSQL("update patient_request
				set request_id = %N, schedule_id = %N, problem_history = %Q, actual_date_of_consultation = %Q, time_of_consultation = %Q where patient_id = %N ",
	...
	function updateSchedule_id($patient_request) {
		$sql = $this->mkSQL("update patient_request
				set request_id = %N, patient_id = %N, problem_history = %Q, actual_date_of_consultation = %Q, time_of_consultation = %Q where schedule_id = %N ",
	...
	function updateProblem_history($patient_request) {
		$sql = $this->mkSQL("update patient_request
				set request_id = %N, patient_id = %N, schedule_id = %N, actual_date_of_consultation = %Q, time_of_consultation = %Q where problem_history = %Q ",
	...
	function updateActual_date_of_consultation($patient_request) {
		$sql = $this->mkSQL("update patient_request
				set request_id = %N, patient_id = %N, schedule_id = %N, problem_history = %Q, time_of_consultation = %Q where actual_date_of_consultation = %Q ",
	...
	function updateTime_of_consultation($patient_request) {
		$sql = $this->mkSQL("update patient_request
				set request_id = %N, patient_id = %N, schedule_id = %N, problem_history = %Q, actual_date_of_consultation = %Q where time_of_consultation = %Q ",
