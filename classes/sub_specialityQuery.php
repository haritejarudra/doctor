...
class Sub_specialityQuery extends Query {
	...
	function selectSpeciality_id($sub_speciality) {
		$sql = $this->mkSQL("select * from sub_speciality where speciality_id  = %N",
				$sub_speciality->getSpeciality_id(),
			);
		if (!$this->_query($sql, "Error in selecting from table sub_speciality")) {
			 return false;
		}
	...
	function insert($sub_speciality) {
		$sql = $this->mkSQL("insert into sub_speciality values (%Q, %Q, %Q)",
				$sub_speciality->getSub_speciality_id(),$sub_speciality->getSpeciality_id(),$sub_speciality->getSpeciality())
			);
	...
	function updateSub_speciality_id($sub_speciality) {
		$sql = $this->mkSQL("update sub_speciality
				set speciality_id = %Q, speciality = %Q where sub_speciality_id  = %N",
				$sub_speciality->getSpeciality_id(),$sub_speciality->getSpeciality(),$sub_speciality->get(),$sub_speciality->getSub_speciality_id()
			);
		$ret = $this->_query($sql,"Update using column sub_speciality_id failed on sub_speciality table");
	}
	function updateSpeciality_id($sub_speciality) {
		$sql = $this->mkSQL("update sub_speciality
				set sub_speciality_id = %Q, speciality = %Q where speciality_id  = %N",
				$sub_speciality->getSub_speciality_id(),$sub_speciality->getSpeciality(),$sub_speciality->get(),$sub_speciality->getSpeciality_id()
			);
		$ret = $this->_query($sql,"Update using column speciality_id failed on sub_speciality table");
	}
	function updateSpeciality($sub_speciality) {
		$sql = $this->mkSQL("update sub_speciality
				set sub_speciality_id = %Q, speciality_id = %Q where speciality  = %N",
				$sub_speciality->getSub_speciality_id(),$sub_speciality->getSpeciality_id(),$sub_speciality->get(),$sub_speciality->getSpeciality()
			);
	...
	function deleteSpeciality_id($sub_speciality) {
		$sql = $this->mkSQL("delete from sub_speciality where speciality_id  = %N",
				$sub_speciality->getSpeciality_id(),
			);
		$ret = $this->_query($sql,"Delete using column speciality_id failed on sub_speciality table");
	}
